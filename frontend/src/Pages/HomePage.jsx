...
const HomePage = () => {
  ...
  const categories = [
    "All", "Gaming", "Education", "Music", "Tech",
    "Live", "Cinema", "AI", "Lifestyle", "Family", "Sports", "Vlog"
  ];
  ...
  // Use the first real video as the featured video
  const featuredVideo = videos[0] || null;
  const featuredId = featuredVideo ? (featuredVideo.id || featuredVideo._id) : null;
    ...
    <div className="p-6 space-y-8 animate-in fade-in duration-700">
      ...
      >
        ...
        <div className="absolute bottom-8 left-8 max-w-xl space-y-4 text-left">
          ...
          <h2 className="text-4xl md:text-5xl font-black leading-tight text-white italic uppercase drop-shadow-lg">
          ...
          {featuredId && (
            <div className="flex items-center gap-2 bg-[#00F0FF] text-black px-4 py-2 rounded-full w-fit font-black text-xs uppercase tracking-wider shadow-[0_0_20px_rgba(0,240,255,0.5)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
