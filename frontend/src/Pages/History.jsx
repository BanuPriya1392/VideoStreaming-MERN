...
import { Clock, Play, Calendar, Trash2, X } from "lucide-react";
import { useLibrary } from "../context/LibraryContext";

const History = () => {
  const { history, clearHistory, removeFromHistory } = useLibrary();
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-red-500/0 hover:bg-red-500/10 text-gray-500 hover:text-red-500 transition-colors"
